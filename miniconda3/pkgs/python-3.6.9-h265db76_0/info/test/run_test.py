#  tests for python-3.6.9-h265db76_0 (this is a generated file);
print('===== testing package: python-3.6.9-h265db76_0 =====');
...
if sys.platform != 'win32':
    # this is getting the variant set at build time
    assert os.getenv("openssl") in ssl.OPENSSL_VERSION
#  --- run_test.py (end) ---

print('===== python-3.6.9-h265db76_0 OK =====');
