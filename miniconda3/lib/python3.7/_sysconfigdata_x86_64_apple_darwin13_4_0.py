...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'x86_64-apple-darwin13.4.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/home/lhn/miniconda3/lib '
 ...
 'CFLAGS': '-fno-strict-aliasing -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-fdebug-prefix-map=/home/lhn/miniconda3=/usr/local/src/conda-prefix '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-pie -Wl,-headerpad_max_install_names '
                      ...
                      '-L/home/lhn/miniconda3/lib '
                      '-flto -Wl,-export_dynamic',
 'CONFIG_ARGS': "'--prefix=/home/lhn/miniconda3' "
 ...
 'LIBFFI_INCLUDEDIR': '/home/lhn/miniconda3/include',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/lhn/miniconda3/lib/pkgconfig',
 'LIBPL': '/home/lhn/miniconda3/lib/python3.7/config-3.7m-darwin',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/home/lhn/miniconda3/include',
 'OPENSSL_LDFLAGS': '-L/home/lhn/miniconda3/lib',
